...
namespace caffe{
	...
	public:
		...
		virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
			const vector<Blob<Dtype>*>& top){} //if this is a func which is not has definition
		virtual inline const char* type() const { return "RPN"; }

		//====up is the classic definition,down is add=====
		struct abox
		{
			Dtype batch_ind;
			Dtype x1;
	...
	protected:
		...
		vector<int> feat_strides_;//fpn add
