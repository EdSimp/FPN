...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rpn_param', full_name='caffe.LayerParameter.rpn_param', index=59,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='asroi_param', full_name='caffe.LayerParameter.asroi_param', index=60,
...
_ASROIPARAMETER = _descriptor.Descriptor(
  name='AsRoiParameter',
  full_name='caffe.AsRoiParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='post_nms_topn', full_name='caffe.AsRoiParameter.post_nms_topn', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['asroi_param'].message_type = _ASROIPARAMETER
...
DESCRIPTOR.message_types_by_name['AsRoiParameter'] = _ASROIPARAMETER
...
AsRoiParameter = _reflection.GeneratedProtocolMessageType('AsRoiParameter', (_message.Message,), dict(
  DESCRIPTOR = _ASROIPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.AsRoiParameter)
  ))
_sym_db.RegisterMessage(AsRoiParameter)
